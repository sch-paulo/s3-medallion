...
def generate_messy_data(num_records, num_duplicates):
    data = {
        ...
        'salary': [randint(20000, 200000) if random() > 0.92 else randint(-5000, 19999) for _ in range(num_records)],
        ...
        'status': choices(['active', 'ACTIVE', 'inactive', 'INACTIVE', 'pending', ''], weights=[8, 8, 8, 8, 6, 1], k=num_records)
    }   
...
if __name__ == '__main__':   
    raw_df = generate_messy_data(10000, 120)
